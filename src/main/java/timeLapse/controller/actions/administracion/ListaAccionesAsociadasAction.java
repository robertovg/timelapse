...
@Service("listaAccionesAsociadasAction")
@Scope("request")
public class ListaAccionesAsociadasAction extends ActionTemplate{
	...
	public String execute() throws Exception {
		List<TlpAccion> accionesNeg = neg.listaAccionesAsociadas(oidRol);
	 ...
	 * @return the oidRol
	 */
	@RequiredStringValidator(key = "ListaAccionesAsociadasAction.oidRol.obl")
