...
/**
 * Action para listar las tareas pertenecientes al grupo pasado como parámetro y que no están asociadas a 
 * ningún usuario 
 * @author robe
 * 
 */
@SuppressWarnings("serial")
@Service("listaTareasDelGrupoSinAsociarUsuarioAction")
@Scope("request")
public class ListaTareasDelGrupoSinAsociarUsuarioAction extends ListaTareasActionTemplate {
	@Resource
	ITareaBO neg;
	...
	public ListaTareasDelGrupoSinAsociarUsuarioAction() {
	...
	public String execute() throws Exception {
		identifier = "oid";
		//Solo devuelve datos cuando se le envía algu con como grupo
		if(!grupos.equals(VALOR_TODAS_EN_LISTAS)){
			...
			filtro.setVinculadasUsuario(EstadoFilros.excluir);
			if(categorias != null){
