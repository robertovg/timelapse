...
<input id="filtroGridPrimero" 
	...
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.tareas.vincularTareaTarea.tareasPadre.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridPrimero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.tareas.vincularTareaTarea.jsonStorePrimero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			<div dojoType="dijit.form.Button" id="botonSeleccionSiguiente" label="<fmt:message key="timeLapse.jsp.tareas.vincularTareaTarea.botones.seleccionarSegundo"/>" class="boton"></div>				
		</div>
...
<input id="filtroGridSegundo" 
	...
	<b class="divRedondo5"></b></b>
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.tareas.vincularTareaTarea.tareasHija.title"/></h1>
	</div>
		...
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridSegundo" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.tareas.vincularTareaTarea.jsonStoreSegundo" 
