...
<input id="filtroGridPrimero" 
	...
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularTareaGrupo.grupos.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridPrimero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularTareaGrupo.jsonStorePrimero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			<div dojoType="dijit.form.Button" id="botonSeleccionSiguiente" label="<fmt:message key="timeLapse.jsp.grupos.vincularTareaGrupo.botones.seleccionarSegundo"/>" class="boton"></div>				
		</div>
...
<input id="filtroGridSegundo" 
	...
	<b class="divRedondo5"></b></b>
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularTareaGrupo.tareasSinGrupo.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridSegundo" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularTareaGrupo.jsonStoreSegundo" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			...
			<div dojoType="dijit.form.Button" id="botonVincular" label="<fmt:message key="timeLapse.jsp.grupos.vincularTareaGrupo.botones.vincular"/>" class="boton"></div>				
		</div>
