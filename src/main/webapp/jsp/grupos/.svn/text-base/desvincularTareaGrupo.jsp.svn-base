...
<input id="filtroGridPrimero" 
	...
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.desvincularTareaGrupo.tareasConGrupos.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridPrimero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.desvincularTareaGrupo.jsonStorePrimero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			<div dojoType="dijit.form.Button" id="botonDesvincula" label="<fmt:message key="timeLapse.jsp.grupos.desvincularTareaGrupo.botones.desvincular"/>" class="boton"></div>				
		</div>
