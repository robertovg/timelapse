...
<div class="divNegro">
<h1 ><fmt:message key="timeLapse.jsp.grupos.adminGrupos.title" /></h1>
</div>
	...
	<div class="partsContainer"> 
		<div class="gridContainer"> 
			<table id="grid" dojoType="dojox.grid.DataGrid"
	       		query="{ nombre :'*' }" store="timeLapse.grupos.adminGrupos.jsonStore" 
...
<div dojoType="dijit.Dialog" id="formularioPopUp" class="popUp" title="<fmt:message key="timeLapse.jsp.grupos.adminGrupos.titleFormulario"/>" >
	<form onsubmit="return false" dojoType="dijit.form.Form" id="myForm" 
		...
		<div class="elemFormulario">
			<span class="cajaTexto">
				<span class="labelTexto"><fmt:message key="timeLapse.jsp.grupos.adminGrupos.inputNombre"/></span>
			</span>
			<span class="cajaInputGran">
				<input id="formNombre" 
					...
					required="true"
					trim="true"  
					promptMessage="<fmt:message key="timeLapse.jsp.grupos.adminGrupos.tooltipNombre"/>"
					type="text"
					maxLength="100"
					name="formNombre"/>
			</span>
		...
		<div class="elemFormulario">
			<span class="cajaTexto">
				<span class="labelTexto"><fmt:message key="timeLapse.jsp.grupos.adminGrupos.inputDescripcion"/></span>
			</span>
			<span class="cajaInputGran">
				<input id="formDesc" 
					dojoType="dijit.form.ValidationTextBox"
					trim="true"
					promptMessage= "<fmt:message key="timeLapse.jsp.grupos.adminGrupos.tooltDescripcion"/>"  
					type="text"
					maxLength="500"
					name="formDesc"/>
			</span>
