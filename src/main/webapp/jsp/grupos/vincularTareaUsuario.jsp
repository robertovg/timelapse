...
<input id="filtroGridPrimero" 
	...
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.grupos.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridPrimero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularTareaUsuario.jsonStorePrimero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			<div dojoType="dijit.form.Button" id="botonSeleccionSegundo" label="<fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.botones.seleccionarSegundo"/>" class="boton"></div>				
		</div>
...
<input id="filtroGridSegundo" 
	...
	<b class="divRedondo5"></b></b>
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.usuariosAplicacion.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridSegundo" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularTareaUsuario.jsonStoreSegundo" 
		       		selectionMode="single" queryOptions="{ignoreCase: true}"
		...
		<div class="contenedorBotones" id="botonesPrin">
			...
			<div dojoType="dijit.form.Button" id="botonSeleccionTercero" label="<fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.botones.seleccionarTercero"/>" class="boton"></div>				
		</div>
...
<input id="filtroGridTercero" 
	...
	<b class="divRedondo5"></b></b>
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.tareas.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridTercero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularTareaUsuario.jsonStoreTercero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			...
			<div dojoType="dijit.form.Button" id="botonVincular" label="<fmt:message key="timeLapse.jsp.grupos.vincularTareaUsuario.botones.vincular"/>" class="boton"></div>				
		</div>
