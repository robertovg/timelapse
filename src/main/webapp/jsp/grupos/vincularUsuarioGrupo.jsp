...
<input id="filtroGridPrimero" 
	...
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularUsuarioGrupo.grupos.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridPrimero" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularUsuarioGrupo.jsonStorePrimero" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			<div dojoType="dijit.form.Button" id="botonSeleccionSiguiente" label="<fmt:message key="timeLapse.jsp.grupos.vincularUsuarioGrupo.botones.seleccionarSegundo"/>" class="boton"></div>				
		</div>
...
<input id="filtroGridSegundo" 
	...
	<b class="divRedondo5"></b></b>
	<div class="divNegro">
	<h1><fmt:message key="timeLapse.jsp.grupos.vincularUsuarioGrupo.usuariosAplicacion.title"/></h1>
	</div>
	...
	<div class="contenedorFormulario">
		<div class="partsContainer"> 
			<div class="gridContainer"> 
				<table id="gridSegundo" dojoType="dojox.grid.DataGrid"
		       		query="{ nombre :'*' }" store="timeLapse.grupos.vincularUsuarioGrupo.jsonStoreSegundo" 
		...
		<div class="contenedorBotones" id="botonesPrin">
			...
			<div dojoType="dijit.form.Button" id="botonVincular" label="<fmt:message key="timeLapse.jsp.grupos.vincularUsuarioGrupo.botones.vincular"/>" class="boton"></div>				
		</div>
