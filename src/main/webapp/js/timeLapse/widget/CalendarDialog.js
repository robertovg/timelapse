dojo.provide("timeLapse.widget.CalendarDialog");
...
dojo.declare(
	"timeLapse.widget.CalendarDialogNewEntry",
	[dijit.Dialog],
{
	// summary:
	// This is the actual content.
	templatePath: dojo.moduleUrl("timeLapse.widget","templates/newcalendarentry.html"),
	...
	ok: function(){
		...
		if(!isOk){
			dojo.require("timeLapse.widget.ModalAlert");
			var params = {
				height: "230px",
				iconSrc: dojo.moduleUrl("timeLapse.widget","templates/images/error.gif"),
				alertText: '<strong>Please edit/complete the following field(s):</strong><br />' + alertText
			};
			var modal = new timeLapse.widget.ModalAlert(params);
		}else{
			var oEntry = {
...
dojo.declare(
	"timeLapse.widget.CalendarDialogTimezone",
	[dijit.Dialog],
    {
	// summary:
	// This is the actual content.
	templatePath: dojo.moduleUrl("timeLapse.widget","templates/timezones.html"),
	widgetsInTemplate: true,
	openerId: "",
...
dojo.declare(
	"timeLapse.widget.CalendarDialogChangeTime",
	[dijit._Widget, dijit._Templated],
{
	// summary:
	// This is the actual content.
	templatePath: dojo.moduleUrl("timeLapse.widget","templates/changetime.html"),
	widgetsInTemplate: true,
	openerId: "",
	itemId: "",
	eventChanged: false,
...
dojo.declare(
	"timeLapse.widget.CalendarDialog",
	[dijit._Widget],
	{
		// summary:
		//		Provides a Dialog which can be modal or normal.
		//templatePath: dojo.moduleUrl("timeLapse.widget","templates/Editor2/EditorDialog.html"),
...
//			timeLapse.widget.CalendarDialog.superclass.fillInTemplate.call(this, args, frag);
		},
		postCreate: function(){
			if(this.modal){
...
//          dojo.widget.FloatingPaneBase.prototype.postCreate.apply(this, arguments);
			timeLapse.widget.CalendarDialog.superclass.postCreate.call(this);
		...
		show: function(){
			if(!this.contentWidget){
				this.inherited(arguments);
//              timeLapse.widget.CalendarDialog.superclass.show.apply(this, arguments);
				this.createContent();
				this.hide();
//              timeLapse.widget.CalendarDialog.superclass.hide.call(this);
			}
...
//              place the background div under this modal pane
		...
		onShow: function(){
			timeLapse.widget.CalendarDialog.superclass.onShow.call(this);
			this.onFloatingPaneShow();
		},
		closeWindow: function(){
			this.hide();
			this.inherited(arguments);
//          timeLapse.widget.CalendarDialog.superclass.closeWindow.apply(this, arguments);
		},
		hide: function(){
			if(this.modal){
